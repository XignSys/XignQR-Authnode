 ...
 *     this.tools = tools;
 * }
 * </code></pre> So that you can use the addSmsService api to load your schema
 * XML for example. PluginTools javadoc may be found
...
public class XignNodePlugin extends AbstractNodeAmPlugin {
     ...
     * These will then be installed and registered at the appropriate times in
     * plugin lifecycle.
     *
    ...
    /**
     * Handle plugin installation. This method will only be called once, on
     * first AM startup once the plugin is included in the classpath. The
     ...
     * @see
     * <a href="https://www.osgi.org/wp-content/uploads/SemanticVersioning.pdf">Semantic
     * Versioning</a>
     */
    @Override
